...
$classes = Flux::classes()
    ...
    ->add(match ($size) {
        'xl' => 'text-2xl font-semibold [&:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&]:mt-2',
        'lg' => 'text-base font-semibold [&:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&]:mt-2',
